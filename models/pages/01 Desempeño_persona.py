...
def plot_student_performance(df, student_name):
    ...
    plt.text(np.pi/4, 2.4, '3', fontsize=7, color='#444444', ha='right', va='bottom')
    plt.text(np.pi/4, 3.4, '4', fontsize=7, color='#444444', ha='right', va='bottom')
    plt.text(np.pi/4, 4.4, '5', fontsize=7, color='#444444', ha='right', va='bottom')
